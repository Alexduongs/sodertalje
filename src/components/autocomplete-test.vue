    ...
    <div class="example">
      ...
      >
        ...
        >
          ...
          <div class="text" :style="[scope.suggestion.Status == 'Gällande' ? {'background': '#87BDC9'} : scope.suggestion.Status == 'Remiss' ? {'background': '#E9A15F'} : scope.suggestion.Status == 'Under framtagande' ? {'background': '#5F8C9A'} : {'background': '#C45941'} ]">
